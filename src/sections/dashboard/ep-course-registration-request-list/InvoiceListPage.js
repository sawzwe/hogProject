...
function createData(id, requestDate, courseType, section, registeredCourses, role, status) {
  return { id, requestDate, courseType, section, registeredCourses, role, status };
}
...
const TABLE_HEAD_REQUESTS = [
  ...
  { id: 'section ', label: 'Section', align: 'center', width: 140 },
  { id: 'registredCourses', label: 'Registered Courses(s)', align: 'center', width: 140 },
  { id: 'requestedBy', label: 'Requested by (EP)', align: 'left' },

  // { id: 'role', label: 'Requested by (EP) ', align: 'left' },
  // { id: 'status', label: 'Status', align: 'left' },
  { id: '' },
];
...
const TABLE_DATA_REQUESTS = [
  ...
  createData('R032', '30-Oct-2022', 'Semi Private', 'Semi Private 20'        , 1,    'Nirawit(Boss)', 'payment'  , 'completed '),
  createData('R014', '16-Nov-2022', 'Private'     , 'Thanatuch Lertritsirkul', 2,    'Nirawit(Boss)', 'payment'  , 'rejected '),
  createData('R302', '28-Nov-2022', 'Private'     , 'Saw Zwe Wai Yan'        , 1,    'Nirawit(Boss)', 'pendingEA', 'completed '),
  createData('R254', '03-Nov-2022', 'Semi Private', 'Semi Private 25'        , 3,    'Nirawit(Boss)', 'pendingEA', 'rejected'),
  createData('R561', '30-Nov-2022', 'Semi Private', 'Semi Private 20'        , 1,    'Nirawit(Boss)', 'pendingOA', 'rejected '),
  createData('R592', '25-Dec-2022', 'Private'     , 'Piyaphon Wu'            , 2,    'Nirawit(Boss)', 'pendingOA', 'completed '),
  createData('R682', '30-Dec-2022', 'Semi Private', 'Semi Private 20'        , 1,    'Nirawit(Boss)', 'payment'  , 'completed '),
...
export default function InvoiceListPage() {
  ...
  const TABS = [
    ...
    { value: 'paid', label: 'EP', color: 'success', count: getLengthByStatus('paid') },
