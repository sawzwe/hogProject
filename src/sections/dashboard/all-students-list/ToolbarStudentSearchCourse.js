...
ToolbarStudentSearchCourse.propTypes = {
  open: PropTypes.bool,
...
export default function ToolbarStudentSearchCourse({ filterValue, onFilterValue, open, onOpen, onClose, isDefault, onResetFilter }) {
